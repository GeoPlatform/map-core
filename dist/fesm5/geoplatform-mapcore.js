...
import { Control, Util, DomUtil, Map, DomEvent, layerGroup, polyline, CircleMarker, divIcon, marker, control, FeatureGroup, GeoJSON, MarkerClusterGroup, icon, circleMarker, SVG, svg, Canvas, canvas, TileLayer, popup, Layer, TimeDimension, Browser, Point, LatLng, stamp, featureGroup, geoJSON, LayerGroup } from 'leaflet';
